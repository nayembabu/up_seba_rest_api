...
--
-- Table structure for table `certificate_entry`
--

CREATE TABLE `certificate_entry` (
  `cer_p_iddd` int(11) NOT NULL,
...
--
-- Table structure for table `cer_deft`
--

CREATE TABLE `cer_deft` (
  `cer_def_p_iidi` int(11) NOT NULL,
  `cer_deft_desc` longtext COLLATE utf8_unicode_ci NOT NULL,
  `cer_title` longtext COLLATE utf8_unicode_ci NOT NULL,
  `bn/en` varchar(5) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `cer_deft`
--

INSERT INTO `cer_deft` (`cer_def_p_iidi`, `cer_deft_desc`, `cer_title`, `bn/en`) VALUES
(1, '10', '10', '1'),
(3, '20001', '55110', '2'),
(4, '20001', '55110', '2'),
(5, '20001', '55110', '2');
...
--
-- Table structure for table `dist_list`
--

CREATE TABLE `dist_list` (
  `dist_id` int(11) NOT NULL,
  `division_id` int(11) NOT NULL,
  `dist_name` varchar(25) COLLATE utf8mb4_unicode_ci NOT NULL,
  `dist_bn_name` varchar(25) COLLATE utf8mb4_unicode_ci NOT NULL,
  `dist_lat` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dist_lon` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dist_url` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL
...
INSERT INTO `dist_list` (`dist_id`, `division_id`, `dist_name`, `dist_bn_name`, `dist_lat`, `dist_lon`, `dist_url`) VALUES
...
--
-- Table structure for table `div_list`
--
...
--
-- Dumping data for table `div_list`
--

INSERT INTO `div_list` (`div_id`, `div_name`, `div_bn_name`, `div_url`) VALUES
...
CREATE TABLE `settings` (
  ...
  `div_a_idd` int(10) DEFAULT NULL,
  `dis_a_idd` int(10) NOT NULL,
  `up_a_idd` int(10) NOT NULL,
  `un_a_idd` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Table structure for table `un_list`
--
...
--
-- Dumping data for table `un_list`
--

INSERT INTO `un_list` (`un_id`, `upazilla_id`, `un_name`, `un_bn_name`, `un_url`) VALUES
...
--
-- Table structure for table `up_list`
--
...
--
-- Dumping data for table `up_list`
--

INSERT INTO `up_list` (`up_id`, `district_id`, `up_name`, `up_bn_name`, `up_url`) VALUES
...
--
-- Indexes for table `certificate_entry`
--
ALTER TABLE `certificate_entry`
  ADD PRIMARY KEY (`cer_p_iddd`);

--
-- Indexes for table `cer_deft`
--
ALTER TABLE `cer_deft`
  ADD PRIMARY KEY (`cer_def_p_iidi`);

--
-- Indexes for table `dist_list`
--
ALTER TABLE `dist_list`
  ADD PRIMARY KEY (`dist_id`),
  ADD KEY `division_id` (`division_id`);

--
-- Indexes for table `div_list`
--
ALTER TABLE `div_list`
...
ALTER TABLE `settings`
  ADD PRIMARY KEY (`setting_p_iid`);

--
-- Indexes for table `un_list`
--
ALTER TABLE `un_list`
...
--
ALTER TABLE `cer_deft`
  MODIFY `cer_def_p_iidi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `dist_list`
--
ALTER TABLE `dist_list`
  MODIFY `dist_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;

--
-- AUTO_INCREMENT for table `div_list`
--
ALTER TABLE `div_list`
...
--
ALTER TABLE `settings`
  MODIFY `setting_p_iid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `un_list`
--
ALTER TABLE `un_list`
  MODIFY `un_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4541;

--
-- AUTO_INCREMENT for table `up_list`
--
ALTER TABLE `up_list`
  MODIFY `up_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=492;
...
--
-- Constraints for table `dist_list`
--
ALTER TABLE `dist_list`
  ADD CONSTRAINT `dist_list_ibfk_2` FOREIGN KEY (`division_id`) REFERENCES `div_list` (`div_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `un_list`
--
ALTER TABLE `un_list`
  ADD CONSTRAINT `un_list_ibfk_2` FOREIGN KEY (`upazilla_id`) REFERENCES `up_list` (`up_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `up_list`
--
ALTER TABLE `up_list`
  ADD CONSTRAINT `up_list_ibfk_2` FOREIGN KEY (`district_id`) REFERENCES `dist_list` (`dist_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
